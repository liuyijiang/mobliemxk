...
//
	...
	public String metooUserSharePartsView(){
		uservo = super.getCurrentUserVO();
		if(uservo != null){
			allpage = partService.findUserShareSinglePartsAllPage(uservo.getId());
			return SUCCESS;	
		}else{
			return ERROR;	
		}
	...
	public String metooUserRegisterView(){
		return SUCCESS;
	}
	
	//注册
	public String metooUserRegister(){
...
//	
	...
	//登陆
	public String metooShowUserLoginView(){
		return SUCCESS;
	}
//	
	//登陆in
	public String metooUserLoginIn(){
	...
	//首页
	public String metooUserIndexView(){
		uservo = super.getCurrentUserVO();
		if(uservo != null){
			return SUCCESS;
		}else{
...
//	
//	//用户分享单一parts
//	public String metooUserShareSinglePartsIndexView(){
//		uservo = super.getCurrentUserVO();
//		if(uservo != null){
...
//	}
	...
	//所有parts
	public String metooUserShowPartDashBoardView(){
		uservo = super.getCurrentUserVO();
		if(uservo != null){
			allpage = partService.findUserShareSinglePartsAllPage(uservo.getId());
			return SUCCESS;
