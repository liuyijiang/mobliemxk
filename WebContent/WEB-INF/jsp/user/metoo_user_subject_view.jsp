...
<div class="container">
  <span class="pull-left" id="partTitle"><strong>我的专辑</strong></span>
...
<%@ include file="../../../basefootinclude.jsp"%>  
 <script type="text/javascript">
   ...
   function loadMore(isNext){
	   ...
	   var datas = {"searchSubjectRequest.useid":userid,"searchSubjectRequest.page":page};
	   $("#partsdivshow").load(path +'/loadMoreUserSubject',datas,function() {
	    	$("#loaddiv").hide();
