     ...
     <div class="span11">
        ...
        <span>
         ...
         <div class="btn-group pull-right">
		  <a href="javascript:;" class="btn btn-mini" style="font-family:Microsoft YaHei;"><i class="icon-hdd"></i>专题${targetUserVO.subject }</a>
		  <a href="javascript:;" class="btn btn-mini" style="font-family:Microsoft YaHei;"><i class="icon-rss"></i>关注${targetUserVO.focus }</a>
		  <a href="javascript:;" class="btn btn-mini" style="font-family:Microsoft YaHei;"><i class="icon-group"></i>粉丝${targetUserVO.followors }</a>
		 </div>
        <br />
     </div>
  </div>
